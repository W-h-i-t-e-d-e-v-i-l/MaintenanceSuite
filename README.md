...
3.Error Alerts:	/c/Users/HP/Desktop/AbhijitBehura/MaintenanceSuite/logs/errors_found.txt

🧩 Requirements

1.Git Bash (installed on Windows)

2.PowerShell (used to clear the Recycle Bin and fetch Event Logs)

3,Basic understanding of shell commands
